...
export const disasters = {
  fire: {
    ...
    procedures: [
      ...
      "Do NOT use elevators (if applicable) - use stairs only",
      ...
      "Call emergency services: Taytay BFP at 0917-148-9964 or Unified 911",
  ...
  earthquake: {
    ...
    procedures: [
      ...
      "Use stairs, not elevators (if applicable)",
...
// Emergency contacts Unified 911
export const emergencyContacts = [
  {
    name: "Unified 911",
    number: "911",
    description: "Immediate police, fire, or medical emergencies anywhere in the Philippines.",
  },
  {
    name: "Taytay Municipal Disaster Risk Reduction and Management Office.",
    number: "0952-619-9511",
    description: "Disaster preparedness, emergency response, and relief operations. Alt number: 0970-884-3791",
  },
  {
    name: "Taytay Bureau of Fire Protection",
    number: "0917-148-9964",
    description: "Fire-related emergencies and rescue operations.",
  },
  {
    name: "Taytay Philippine National Police",
    number: "0998-598-5730",
    description: "Immediate law enforcement and public safety assistance. Alt number: 0917-163-3556",
  },
];
...
export const emergencyRoutes = [
  {
    id: 1,
    floor: "Ground Floor",
    image: "/routes/ground-floor-cp.png",
    description: "Main exits and assembly point",
  },
  {
    id: 2,
    floor: "Second Floor",
    image: "/routes/second-floor-cp.png",
    description: "Stairwell locations and emergency exits",
  },
  {
    id: 3,
    floor: "Third Floor",
    image: "/routes/third-floor-cp.png",
    description: "Stairwell locations and emergency exits",
  },
  {
    id: 4,
    floor: "Fourth Floor",
    image: "/routes/fourth-floor-cp.png",
    description: "Stairwell locations and emergency exits",
  },
];
